...
VkDescriptorImageInfo VulkanEngine::get_image_resource(const char* name) {
	const TextureResource& texture_env = getResource<TextureResource>(name);//render_registry.get<TextureResource>();
	VkDescriptorImageInfo imageInfo = {};
	imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL; //+vkf::ImageLayout::eShaderReadOnlyOptimal;
