...
VkPipelineShaderStageCreateInfo vkinit::pipeline_shader_stage_create_info(vkf::ShaderStageFlagBits stage, VkShaderModule module)
{
...
VkImageViewCreateInfo vkinit::image_view_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectMask)
{
...
VkSamplerCreateInfo vkinit::sampler_create_info(VkFilter filters, VkSamplerAddressMode samplerAdressMode)
{
...
VkDescriptorPoolCreateInfo vkinit::descriptor_pool_create_info(vke::Span<VkDescriptorPoolSize> poolSizes, uint32_t maxSets, VkDescriptorPoolCreateFlags flags /*= 0*/)
{
	VkDescriptorPoolCreateInfo pool_info = {};
	pool_info.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
	pool_info.flags = VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT;
	pool_info.maxSets = maxSets;
	pool_info.poolSizeCount = poolSizes.count();
	pool_info.pPoolSizes = poolSizes.first;
	return pool_info;
}
